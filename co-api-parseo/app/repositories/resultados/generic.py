...
class ResultRepository:
 ...
 def insert_records(self,tipo,id_archivo,records,on_progress=None,progress_every=500):
  ...
  for rec in records:
   ...
   if on_progress and count%progress_every==0: on_progress(count)
  if on_progress: on_progress(count)
  return count
