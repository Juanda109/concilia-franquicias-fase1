...
compartidos por `concilia_backend` y `concilia_parseo` (mismo `DATABASE_URL`,
...
export DATABASE_URL="postgresql://${POSTGRES_USER}:${POSTGRES_PASSWORD}@concilia-postgres:5432/${POSTGRES_DB}"
export MINIO_ENDPOINT=concilia-minio:9000
