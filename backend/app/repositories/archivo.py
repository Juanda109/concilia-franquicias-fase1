class ArchivoRepository:
 ...
 def update_state(self,id_archivo,field,value,motivo=None):
  allowed={"ESTADO_RECEPCION","ESTADO_VALIDACION","ESTADO_PROCESAMIENTO","ESTADO_CARGA","ESTADO_DISPONIBILIDAD"}
 ...
 def set_available(self,id_archivo,value=True):
  self.conn.execute("UPDATE CON_ARCHIVO_CARGA SET DISPONIBLE=%s,ESTADO_DISPONIBILIDAD=%s WHERE ID_ARCHIVO=%s",(value,"DISPONIBLE" if value else "NO_DISPONIBLE",id_archivo))
 ...
 (ID_JORNADA,ID_INSUMO,NOMBRE_ARCHIVO,ESTADO_RECEPCION,ESTADO_VALIDACION,ESTADO_PROCESAMIENTO,ESTADO_CARGA,ESTADO_DISPONIBILIDAD,CORRELATION_ID)
 VALUES (%s,%s,%s,'RECIBIDO','NO_INICIADA','NO_INICIADO','NO_INICIADA','NO_DISPONIBLE',%s) RETURNING ID_ARCHIVO""",
